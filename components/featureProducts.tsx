...
export default function FeatureProducts() {
  ...
  return (
    ...
    <section id="feature-products-section" className="relative z-10">
      <div
        className={`bg-gray-200 p-8 md:p-12 lg:p-16 transition-opacity duration-700 ${
        ...
        <div className="flex flex-col md:flex-row lg:pl-24 lg:pr-16 gap-10 items-stretch">
          <div className="grid grid-cols-2 gap-6 flex-1">
            {fans.map((fan, idx) => (
              <TiltCard
                ...
                <Card
                  className="flex bg-[var(--nav-color)]  flex-col items-center justify-center rounded-xl 
          ...
          <div className="flex-1 flex">
            <TiltCard
              ...
              <Card
                className="flex bg-[var(--nav-color)] flex-col items-center justify-between rounded-xl 
                            backdrop-blur-lg border border-white/50
